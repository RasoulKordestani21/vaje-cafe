    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4" dir="rtl">
      <div className="w-full max-w-md bg-neutral-900 p-10 rounded-2xl border border-white/10 shadow-2xl">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-serif font-bold text-white mb-2">ورود به پنل مدیریت</h2>
          <p className="text-gray-400 text-sm">برای مدیریت منو، رمز عبور را وارد کنید.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {error && <p className="text-red-400 text-sm text-center bg-red-900/10 py-2 rounded border border-red-900/20">{error}</p>}
